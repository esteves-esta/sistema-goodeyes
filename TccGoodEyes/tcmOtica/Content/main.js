$(document).ready(function () {
    ...
    $(".formCad").each(function () { 
        $(this).submit(function (e) {
            ...
            if (ChecarInput($('#txtData'), 10) === true || dataValida($('#txtData')) === false) {
...
function dataValida(input) {
    var datai = input.val();
    var d = datai.substring(0, 2);
    var m = datai.substring(3, 5);
    var dateInverse = m + "/" + d + "/" + datai.substring(6, 10); 

    var d = new Date(dateInverse);
